...
namespace ControlDeFinanzas.Servicios
{
    public interface IServicioReportes
    {
        ...
        Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladasPorCuenta(int usuarioId, int mes, int cuentaId, int año, dynamic ViewBag);
    }
...

    {
        ...
        public async Task<IEnumerable<ResultadoObtenerPorSemana>> ObtenerPorSemanas(int UsuarioId,
            int mes, int año, dynamic ViewBag)
        {
            (DateTime fechaInicio, DateTime fechaFin) = GenerarFechaInicioYFin(mes, año);
        ...
        public async Task<ReporteTransaccionesDetalladas>
            ...
            (int usuarioId, int mes, int cuentaId, int año, dynamic ViewBag)
        {
            (DateTime fechaInicio, DateTime fechaFin) = GenerarFechaInicioYFin(mes, año);
        ...
        public Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladasPorCuenta(int usuarioId, int año, dynamic ViewBag)
        {
